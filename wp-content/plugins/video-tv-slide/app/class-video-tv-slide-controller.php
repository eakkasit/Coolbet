...
require_once 'class-video-tv-slide-model.php';
require_once 'class-video-tv-slide-view.php';
require_once 'class-video-tv-slide-update.php';

class Video_TV_Slide_Controller {

	private $view, $model, $update;

	function __construct() {

		$this->model = new Video_TV_Slide_Model($this);	
		$this->view = new Video_TV_Slide_View($this);
		$this->update = new Video_TV_Slide_Update($this);
	...
	function generate_body_code($id, $attributes, $has_wrapper) {
		
		return $this->model->generate_body_code($id, $attributes, $has_wrapper);
	}
	...
	function init() {
		...
		$option_name = 'video-tv-slide-engine';
