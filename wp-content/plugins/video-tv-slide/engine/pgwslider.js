...
; (function ($) {
    $.fn.pgwSlider = function (options) {
        ...
        var getElement = function (obj) {
            ...
            var elementVideo = obj.find('img').attr('data-video-src');
            if ((typeof elementVideo != 'undefined') && (elementVideo != '')) {
                // console.log(typeof elementVideo);
        ...
        var setup = function () {
            ...
            pgwSlider.plugin.find('.ps-list > li').each(function () {
                ...
                // if (element.video) {
                //     currentElement.html('<iframe width="100%" height="90%" src="https://www.youtube.com/embed/tgbNymZ7vqY?autoplay=1"> </iframe>');
                // }
